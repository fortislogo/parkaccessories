  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <div class="image">
	    ...
	    <? } ?>
        <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" id="zoom01" <? if(($this->config->get('beauty_status') == '1') && ($this->config->get('beauty_effects_productimage') == 'zoom')) { echo 'class="cloud-zoom" rel="position:\'right\', adjustX:10, adjustY:0, tint:\'#FFFFFF\', showTitle:false, softFocus:1, smoothMove:5, tintOpacity:0.8"';} else { echo 'rel="prettyPhoto"';} ?>><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div>
      <div class="zoom"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox" rel="prettyPhoto"><img src="catalog/view/theme/beautyshop/image/zoom.png" title="Zoom" alt="Zoom" align="absmiddle"/> Click to Zoom image</a></div>
      <?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional-wrapper navigate-additional">
        <div class="prev"></div>
        <div class="image-additional caruofredsel-additional">
          <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" <? if(($this->config->get('beauty_status') == '1') && ($this->config->get('beauty_effects_productimage') == 'zoom')) { echo 'rel="useZoom: \'zoom01\', smallImage: \''.$thumb.'\'" class="cloud-zoom-gallery"';} else { echo 'rel="prettyPhoto[pp_gal]"';} ?>><img width="80" height="80" class="fade-image" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
          <?php foreach ($images as $image) { ?>
          <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" <? if(($this->config->get('beauty_status') == '1') && ($this->config->get('beauty_effects_productimage') == 'zoom')) { echo 'rel="useZoom: \'zoom01\', smallImage: \''.$image['zoom_thumb'].'\'" class="cloud-zoom-gallery"';} else { echo 'rel="prettyPhoto[pp_gal]"';} ?>><img class="fade-image" src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
          <?php } ?>
        </div>
        <div class="next"></div>
      </div>
