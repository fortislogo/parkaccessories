...
$(document).ready(function() {
      ...
      {
	echo $this->config->get('beauty_custom_js');
      }
      ?>
...
<style type="text/css">
      ...
      if(($this->config->get('beauty_status') == '1'))
      {
	echo $this->config->get('beauty_custom_css');
      }
      ?>
      /* backgrounds */
      body {
	...
	if(strlen($header_font_weight) < strlen($this->config->get('beauty_buttons_font_weight')))
	{
