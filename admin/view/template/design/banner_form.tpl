        ...
        <table id="images" class="list">
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
              ...
              <td class="left"><input type="text" size="4" name="banner_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $banner_image['sort_order']; ?>" /></td>    
...
function addImage() {
	...
	html += '<td class="left"><input type="text" size="4" name="banner_image[' + image_row + '][sort_order]" value="" /></td>';	
