...
<div id="header">
  <div class="div1">
    <div class="div2"><img src="view/image/logo_gray.png" title="<?php echo $heading_title; ?>" onClick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
    ...
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $this->url->link('catalog/events', 'token=' . $this->session->data['token'], 'SSL'); ?>">Events</a></li>
