               ...
               <tr>
                  ...
                  <td>
                     <div class="thumbImage">
                        <a onclick="image_upload('thumbImage', 'thumbThumb');"><img src="<?php echo $thumbImage; ?>" alt="" id="thumbThumb" /></a>
                        <input type="hidden" name="thumb" value="<?php echo $thumb; ?>" id="thumbImage" />
                        <a onclick="image_upload('thumbImage', 'thumbThumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;
                        <a onclick="$('#thumbThumb').attr('src', '<?php echo $no_image; ?>'); $('#thumbImage').attr('value', '');"><?php echo $text_clear; ?></a>
                     </div>
                  </td>
               </tr>
