...
class ControllerShippingFree extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['free_customer_group_id'])) {
			$this->data['free_customer_group_id'] = $this->request->post['free_customer_group_id'];
		} else {
			$this->data['free_customer_group_id'] = $this->config->get('free_customer_group_id');
		}
