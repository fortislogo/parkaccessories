...
ini_set("memory_limit","256M");
	...
	$export_xls_product_list .= "<td colspan='2' align='left' style='background-color:#F0F0F0;'>".date($this->language->get('date_format_usa'), strtotime($result['date_start']))."</td>";
	} elseif ($filter_group == 'order') {
	$export_xls_product_list .= "<td align='left' style='background-color:#F0F0F0;'>".$result['order_id']."</td>";	
	$export_xls_product_list .= "<td align='left' style='background-color:#F0F0F0;'>".date($this->language->get('date_format_usa'), strtotime($result['date_start']))."</td>";		
	} else {
	$export_xls_product_list .= "<td align='left' style='background-color:#F0F0F0;'>".date($this->language->get('date_format_usa'), strtotime($result['date_start']))."</td>";
	$export_xls_product_list .= "<td align='left' style='background-color:#F0F0F0;'>".date($this->language->get('date_format_usa'), strtotime($result['date_end']))."</td>";	
	}
	...
	isset($_POST['cop23']) ? $export_xls_product_list .= "</td>" : '';
	isset($_POST['cop26']) ? $export_xls_product_list .= "<td align='left'>".date($this->language->get('date_format_usa'), strtotime($result['mostrecent']))."</td>" : '';		
