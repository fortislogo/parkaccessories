	...
	private function getForm() {
      ...
      $this->load->model('setting/setting');
		...
		if (isset($this->request->post['thumb'])) {
			...
			$this->data['thumb'] = $article_info['thumb'];
		} else {
			$this->data['thumb'] = '';			
		}
		...
		if (isset($article_info['thumb']) && file_exists(DIR_IMAGE . $article_info['thumb']) && is_file(DIR_IMAGE . $article_info['thumb'])) {
			$this->data['thumbImage'] = $this->model_tool_image->resize($article_info['thumb'], 100, 100);		
		} else {
			$this->data['thumbImage'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
