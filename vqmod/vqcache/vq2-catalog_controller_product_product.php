...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['hidecart'] = $product_info['product_hidden'];
...
//BOF Product Color Option
			...
			$this->data['custom_title_1'] = $product_info['custom_title_1'];
			$this->data['custom_title_2'] = $product_info['custom_title_2'];
	...
	public function tellafriend()
	{
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
		{
			...
			$json['success'] = 'Message sent to a friend';
			$this->request->post['friends'] = array($this->request->post['recipients']);
		...
		else
		{
			...
			if (isset($this->error['recipients'])) 
			{
				$json['error_recipients'] = $this->error['recipients'];
			} 
	...
	private function validate() 
	{
		...
		if (!preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['recipients'])) 
		{
			$this->error['recipients'] = 'Invalid recipients email address';
		}
    
		if (!isset($this->session->data['captcha']) || ($this->session->data['captcha'] != $this->request->post['captcha'])) 
		{
      		$this->error['captcha'] = 'invalid code';
    	}
