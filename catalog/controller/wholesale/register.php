<?php 
class ControllerWholesaleRegister extends Controller {
	private $error = array();
  	...
  	public function index() {
    	...
    	$this->language->load('wholesale/register');
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
		{
			...
			$this->request->post['tax_id'] = $this->request->post['tax'];
			$this->request->post['company_id'] = $this->request->post['company'];
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('wholesale/account', '', 'SSL'),      	
        	'separator' => $this->language->get('text_separator')
      	);
		
      	$this->data['breadcrumbs'][] = array(
        	'text'      => $this->language->get('text_register'),
			'href'      => $this->url->link('wholesale/register', '', 'SSL'),      	
        	'separator' => $this->language->get('text_separator')
      	);
    	...
    	$this->data['action'] = $this->url->link('wholesale/register', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/wholesale/register.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/wholesale/register.tpl';
		} else {
			$this->template = 'default/template/wholesale/register.tpl';
		}
  	...
  	protected function validate() {
		...
		if ($this->config->get('config_wholesale_id')) {
			$this->load->model('catalog/information');
			
			$information_info = $this->model_catalog_information->getInformation($this->config->get('config_wholesale_id'));
